...
Names of the environment-related constants be prefixed as \_ENV\_\_. Existing
constant names will be changed in the future.

Environment variables must be prefixed with `DOCKERIZER_` to distinguish them
from other environment variables. Existing constant names will be changed in the
future.
